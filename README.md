...
1. Clonar el repositorio desde GitHub:
   ...
   git clone https://github.com/AngelHernandezAgoiz/Tarea01.git
...
1. Menú de navegación (rama feature/menu):
   - Se ha añadido un menú de navegación con enlaces internos a las secciones: inicio, sobre el proyecto y contacto.
...
2. Utilizar el menú de navegación para moverse entre las distintas secciones de la página.
